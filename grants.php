...
<div id="grant-guidelines">
  <div class="site-width">
    ...
    <ol>
      <li>Review our <a href="#grant-priorities">Grant Request Funding Priorities</a> to be sure there is a proper fit.</li>
      <li>
        ...
        <div class="bluetext long-string">
          ...
          <?php email("Mollykiblyfritz@cekf.org"); ?><br>
          (414) 217-0397
        </div>
      </li>
    ...
    <ul>
      ...
      <li>Lead contact person information (name, phone, email) as well as a list of all individuals and their respective roles in your organization that will have project oversight and control over the requested funds.<br><br></li>
      <li>Organization's mission statement and any other relevant information.<br><br></li>
      <li>Organization budget.<br><br></li>
      <li>Project Title (when applicable) and BRIEF description.<br><br></li>
      <li>The population to be served and need.<br><br></li>
      <li>Project details.<br><br></li>
      <li>The Grant amount requested.<br><br></li>
      <li>The specific use of the requested funds as well as the budget for the entire project. For events such as conferences, please include proposed dates, speakers and agenda and anticipated attendance numbers.<br><br></li>
      <li>Please provide specific goals for the Project<br><br></li>
